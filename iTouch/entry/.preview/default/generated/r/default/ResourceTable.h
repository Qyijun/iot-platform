...
const int32_t STRING_BLUETOOTH_PERMISSION_REASON = 0x01000008;
const int32_t STRING_LOCATION_PERMISSION_REASON = 0x01000009;
const int32_t STRING_MODULE_DESC = 0x01000004;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000000;
